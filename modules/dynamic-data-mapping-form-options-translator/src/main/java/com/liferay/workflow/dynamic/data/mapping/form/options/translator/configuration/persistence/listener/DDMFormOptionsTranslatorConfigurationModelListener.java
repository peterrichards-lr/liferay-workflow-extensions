...
public class DDMFormOptionsTranslatorConfigurationModelListener implements ConfigurationModelListener {
    private static final Logger _log = LoggerFactory.getLogger(DDMFormOptionsTranslatorConfigurationModelListener.class);
    @Reference
    ...
    public void onBeforeSave(String pid, Dictionary<String, Object> properties)
        ...
        try {
            ...
            throw new ConfigurationModelListenerException(
                    exception, DDMFormOptionsTranslatorConfiguration.class, getClass(),
                    properties);
        } finally {
    ...
    private void _validateUniqueConfiguration(String pid, long formInstanceId)
        ...
        String filterString = String.format(
                ...
                DDMFormOptionsTranslatorConfiguration.class.getName(),
