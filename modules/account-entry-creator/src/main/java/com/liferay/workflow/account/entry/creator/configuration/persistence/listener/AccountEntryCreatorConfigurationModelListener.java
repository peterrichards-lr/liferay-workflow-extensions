...
public class AccountEntryCreatorConfigurationModelListener implements ConfigurationModelListener {
    private static final Logger _log = LoggerFactory.getLogger(AccountEntryCreatorConfigurationModelListener.class);
    @Reference
    ...
    public void onBeforeSave(String pid, Dictionary<String, Object> properties)
        ...
        try {
            ...
            throw new ConfigurationModelListenerException(
                    exception, AccountEntryCreatorConfiguration.class, getClass(),
                    properties);
        } finally {
    ...
    private void _validateNameExists(String identifier) throws Exception {
        if (StringUtil.isBlank(identifier) || WorkflowExtensionsConstants.CONFIG_WORKFLOW_NODE_ID_DEFAULT.equals(identifier)) {
            String message = ResourceBundleUtil.getString(
                    _getResourceBundle(),
                    "an-account-entry-creator-config-must-have-a-valid-workflow-node-identifier");
    ...
    private void _validateUniqueConfiguration(String pid, String identifier)
        ...
        String filterString = String.format(
                ...
                AccountEntryCreatorConfiguration.class.getName(),
        ...
        String message = ResourceBundleUtil.getString(
                _getResourceBundle(),
                "there-is-already-an-account-entry-creator-config-with-the-workflow-node-identifier-x", identifier);
