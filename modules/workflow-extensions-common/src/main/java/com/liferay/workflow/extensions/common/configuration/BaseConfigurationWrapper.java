...
public abstract class BaseConfigurationWrapper<T extends BaseConfiguration> {
    public final long getFormInstanceId() { return _configuration.formInstanceId(); }

    public final boolean isEnabled() { return _configuration.enable(); }
    ...
    public final boolean isWorkflowStatusUpdatedOnException() { return _configuration.updateWorkflowStatusOnException(); }
    ...
    protected final T getConfiguration() { return _configuration; }
