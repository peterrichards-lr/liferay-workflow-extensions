...
@Meta.OCD(
        factory = true,
        id = UserGroupCreatorConfiguration.PID,
        localization = "content/Language", name = "config-user-group-creator-name",
        description = "config-user-group-creator-description"
)
public interface UserGroupCreatorConfiguration extends BaseEntityCreatorActionExecutorConfiguration {
