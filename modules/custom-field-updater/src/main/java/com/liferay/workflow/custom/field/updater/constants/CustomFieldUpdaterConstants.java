...
public class CustomFieldUpdaterConstants {
    ...
    public static final String CONFIG_USE_IN_CONTEXT_USER_FOR_CHANGE_DEFAULT = "false";
    public static final String CONFIG_USE_WORKFLOW_CONTEXT_KEY_FOR_USER_LOOKUP_VALUE_DEFAULT = "true";
    ...
    public static int getEntityType(String label) throws PortalException {
        if (label.equals(TYPE_USER_UPDATE_HELPER)) {
            return USER_UPDATE_HELPER;
        } else if (label.equals(TYPE_ORGANISATION_UPDATE_HELPER)) {
            return ORGANISATION_UPDATE_HELPER;
        } else if (label.equals(TYPE_ACCOUNT_UPDATE_HELPER)) {
