...
public class DDMFormUploadProcessorConfigurationModelListener implements ConfigurationModelListener {
    private static final Logger _log = LoggerFactory.getLogger(DDMFormUploadProcessorConfigurationModelListener.class);
    @Reference
    ...
    private void _validateUniqueConfiguration(String pid, String formInstanceId)
        ...
        String filterString = String.format(
                ...
                DDMFormUploadProcessorConfiguration.class.getName(),
