...
@Meta.OCD(
        factory = true,
        id = UserRoleCreatorConfiguration.PID,
        localization = "content/Language", name = "config-user-role-creator-name",
        description = "config-user-role-creator-description"
)
public interface UserRoleCreatorConfiguration extends BaseEntityCreatorActionExecutorConfiguration  {
    String PID = "com.liferay.workflow.user.role.creator.configuration.UserRoleCreatorConfiguration";
    ...
    @Meta.AD(
            deflt = UserRoleCreatorConstants.CONFIG_ENTITY_CREATION_ATTRIBUTES_DEFAULT,
    ...
    @Meta.AD(
            deflt = UserRoleCreatorConstants.CONFIG_CREATED_ENTITY_IDENTIFIER_WORKFLOW_CONTEXT_KEY_DEFAULT,
   ...
   @Meta.AD(
            deflt = UserRoleCreatorConstants.CONFIG_RETURN_EXISTING_ENTITY_IDENTIFIER_IF_FOUND_DEFAULT,
