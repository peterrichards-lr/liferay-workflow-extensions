...
public class OrganisationCreatorConfigurationModelListener implements ConfigurationModelListener {
    private static final Logger _log = LoggerFactory.getLogger(OrganisationCreatorConfigurationModelListener.class);
    @Reference
    ...
    public void onBeforeSave(String pid, Dictionary<String, Object> properties)
        ...
        try {
            ...
            throw new ConfigurationModelListenerException(
                    exception, OrganisationCreatorConfiguration.class, getClass(),
                    properties);
        } finally {
    ...
    private void _validateNameExists(String identifier) throws Exception {
        if (StringUtil.isBlank(identifier) || WorkflowExtensionsConstants.CONFIG_WORKFLOW_NODE_ID_DEFAULT.equals(identifier)) {
            String message = ResourceBundleUtil.getString(
                    _getResourceBundle(),
                    "an-organisation-creator-config-must-have-a-valid-workflow-node-identifier");
    ...
    private void _validateUniqueConfiguration(String pid, String identifier)
        ...
        String filterString = String.format(
                ...
                OrganisationCreatorConfiguration.class.getName(),
        ...
        String message = ResourceBundleUtil.getString(
                _getResourceBundle(),
                "there-is-already-an-organisation-creator-config-with-the-workflow-node-identifier-x", identifier);
